...
sub test_method
{
  ...
  is($implicit->as_XML, $explicit->as_XML, "$method implicit vs. explicit");
} # end test_method
...
test_method(push_content => $base_tree,
            '0.1', [ p => 'P8' ], [ div => 'End']);

test_method(unshift_content => $base_tree,
            '0.1.1', [ i => 'Italics' ]);

test_method(splice_content => $base_tree, '0.1', # <body>
